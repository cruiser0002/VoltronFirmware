...
// VDAC8_v1_90(Data_Source=0, Initial_Value=100, Strobe_Mode=0, VDAC_Range=0, VDAC_Speed=0, Voltage=255, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC8_4, CY_INSTANCE_SHORT_NAME=VDAC8_4, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=VDAC8_4, )
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=100, Strobe_Mode=0, VDAC_Range=0, VDAC_Speed=0, Voltage=255, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC8_3, CY_INSTANCE_SHORT_NAME=VDAC8_3, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=VDAC8_3, )
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=100, Strobe_Mode=0, VDAC_Range=0, VDAC_Speed=0, Voltage=255, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC8_2, CY_INSTANCE_SHORT_NAME=VDAC8_2, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=VDAC8_2, )
...
// EZI2C_v2_0(BitWidthReplacementString=uint8, BusSpeed_kHz=1000, EnableWakeup=false, Hex1=false, Hex2=false, I2C_Address1=8, I2C_Address2=9, I2C_Addresses=1, I2cBusPort=0, Sub_Address_Size=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=EZI2C_v2_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=EZI2C_1, CY_INSTANCE_SHORT_NAME=EZI2C_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=EZI2C_1, )
module EZI2C_v2_0_10 (
    sda,
    scl);
    inout       sda;
    inout       scl;
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=6000, CompareValue2=63, CONTROL3=1, ControlReg=false, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=true, FF8=false, FixedFunction=true, FixedFunctionUsed=1, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=1, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=12000, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=false, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=true, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=false, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=PWM_v3_30, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_1, CY_INSTANCE_SHORT_NAME=PWM_1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=PWM_1, )
module PWM_v3_30_16 (
    pwm2,
    tc,
    clock,
...
module top ;
    ...
    EZI2C_v2_0_10 EZI2C_1 (
        .sda(Net_7),
        .scl(Net_6));

	wire [1:0] tmpOE__I2C_net;
	wire [1:0] tmpFB_1__I2C_net;
	wire [0:0] tmpINTERRUPT_0__I2C_net;
	electrical [0:0] tmpSIOVREF__I2C_net;
	...
	cy_psoc3_pins_v1_10
		...
		I2C
		 (.oe(tmpOE__I2C_net),
		  .y({2'b0}),
		  .fb({tmpFB_1__I2C_net[1:0]}),
		  .io({Net_7, Net_6}),
		  .siovref(tmpSIOVREF__I2C_net),
		  .interrupt({tmpINTERRUPT_0__I2C_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__I2C_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{2'b11} : {2'b11};
    ...
    OpAmp_v1_90_11 Opamp_3 (
        .Vplus(Net_156),
        .Vout(Net_235),
        .Vminus(Net_261));
    defparam Opamp_3.Mode = 1;

    PGA_Inv_v2_0_12 PGA_Inv_2 (
        .Vin(Net_235),
        .Vref(Net_155),
        .Vout(Net_259));

    OpAmp_v1_90_13 Opamp_4 (
        .Vplus(Net_160),
        .Vout(Net_229),
        .Vminus(Net_225));
    defparam Opamp_4.Mode = 1;

    PGA_Inv_v2_0_14 PGA_Inv_1 (
        .Vin(Net_229),
        .Vref(Net_155),
        .Vout(Net_231));
	...
	wire [0:0] tmpOE__Pin_Safe1_net;
	wire [0:0] tmpIO_0__Pin_Safe1_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Safe1_net;
	electrical [0:0] tmpSIOVREF__Pin_Safe1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Safe1
		 (.oe(tmpOE__Pin_Safe1_net),
		  .y({1'b0}),
		  .fb({Net_6399}),
		  .io({tmpIO_0__Pin_Safe1_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Safe1_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Safe1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Safe1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_Safe2_net;
	wire [0:0] tmpIO_0__Pin_Safe2_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Safe2_net;
	electrical [0:0] tmpSIOVREF__Pin_Safe2_net;

	cy_psoc3_pins_v1_10
		#(.id("27b698a9-dd91-489e-ac1b-be32d45916fb"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Safe2
		 (.oe(tmpOE__Pin_Safe2_net),
		  .y({1'b0}),
		  .fb({Net_6495}),
		  .io({tmpIO_0__Pin_Safe2_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Safe2_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Safe2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Safe2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_Safe_All_net;
	wire [0:0] tmpFB_0__Pin_Safe_All_net;
	wire [0:0] tmpIO_0__Pin_Safe_All_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Safe_All_net;
	electrical [0:0] tmpSIOVREF__Pin_Safe_All_net;

	cy_psoc3_pins_v1_10
		#(.id("241588c0-4200-4101-9a43-dfad85ff9573"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Safe_All
		 (.oe(tmpOE__Pin_Safe_All_net),
		  .y({Net_6496}),
		  .fb({tmpFB_0__Pin_Safe_All_net[0:0]}),
		  .io({tmpIO_0__Pin_Safe_All_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Safe_All_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Safe_All_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Safe_All_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_6496 = Net_6495 | Net_6399;
