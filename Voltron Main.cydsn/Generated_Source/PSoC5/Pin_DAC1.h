...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the Pin_DAC1_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(Pin_DAC1__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in Pin_DAC1_SetInterruptMode() function.
     *  @{
     */
        #define Pin_DAC1_INTR_NONE      (uint16)(0x0000u)
        #define Pin_DAC1_INTR_RISING    (uint16)(0x0001u)
        #define Pin_DAC1_INTR_FALLING   (uint16)(0x0002u)
        #define Pin_DAC1_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Pin_DAC1_INTR_MASK      (0x01u) 
#endif /* (Pin_DAC1__INTSTAT) */
...
/* SIO registers */
#if defined(Pin_DAC1__SIO_CFG)
    #define Pin_DAC1_SIO_HYST_EN        (* (reg8 *) Pin_DAC1__SIO_HYST_EN)
    #define Pin_DAC1_SIO_REG_HIFREQ     (* (reg8 *) Pin_DAC1__SIO_REG_HIFREQ)
    #define Pin_DAC1_SIO_CFG            (* (reg8 *) Pin_DAC1__SIO_CFG)
    #define Pin_DAC1_SIO_DIFF           (* (reg8 *) Pin_DAC1__SIO_DIFF)
#endif /* (Pin_DAC1__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define Pin_DAC1_0_INTTYPE_REG 		(* (reg8 *) Pin_DAC1__0__INTTYPE)
#endif /* (Pin_DAC1__INTSTAT) */

#endif /* CY_PSOC5A... */

#endif /*  CY_PINS_Pin_DAC1_H */
