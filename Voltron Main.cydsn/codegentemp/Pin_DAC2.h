...
#if !(CY_PSOC5A &&\
	 Pin_DAC2__PORT == 15 && ((Pin_DAC2__MASK & 0xC0) != 0))
...
void    Pin_DAC2_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the Pin_DAC2_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(Pin_DAC2__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in Pin_DAC2_SetInterruptMode() function.
     *  @{
     */
        #define Pin_DAC2_INTR_NONE      (uint16)(0x0000u)
        #define Pin_DAC2_INTR_RISING    (uint16)(0x0001u)
        #define Pin_DAC2_INTR_FALLING   (uint16)(0x0002u)
        #define Pin_DAC2_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Pin_DAC2_INTR_MASK      (0x01u) 
#endif /* (Pin_DAC2__INTSTAT) */
...
/* SIO registers */
#if defined(Pin_DAC2__SIO_CFG)
    #define Pin_DAC2_SIO_HYST_EN        (* (reg8 *) Pin_DAC2__SIO_HYST_EN)
    #define Pin_DAC2_SIO_REG_HIFREQ     (* (reg8 *) Pin_DAC2__SIO_REG_HIFREQ)
    #define Pin_DAC2_SIO_CFG            (* (reg8 *) Pin_DAC2__SIO_CFG)
    #define Pin_DAC2_SIO_DIFF           (* (reg8 *) Pin_DAC2__SIO_DIFF)
#endif /* (Pin_DAC2__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define Pin_DAC2_0_INTTYPE_REG 		(* (reg8 *) Pin_DAC2__0__INTTYPE)
#endif /* (Pin_DAC2__INTSTAT) */

#endif /* CY_PSOC5A... */

#endif /*  CY_PINS_Pin_DAC2_H */
