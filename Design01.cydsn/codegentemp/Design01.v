...
// IDAC8_v2_0(Current=960, Data_Source=0, Hardware_Enable=false, IDAC_Range=8, IDAC_Speed=0, Initial_Value=120, Polarity=0, Strobe_Mode=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=IDAC8_v2_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=IDACH, CY_INSTANCE_SHORT_NAME=IDACH, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=IDACH, )
module IDAC8_v2_0_0 (
    iOut,
    data,
    strobe,
...
// IDAC8_v2_0(Current=100, Data_Source=0, Hardware_Enable=false, IDAC_Range=0, IDAC_Speed=0, Initial_Value=120, Polarity=0, Strobe_Mode=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=IDAC8_v2_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=IDACL, CY_INSTANCE_SHORT_NAME=IDACL, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=IDACL, )
module IDAC8_v2_0_3 (
    iOut,
    data,
    strobe,
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=100, Strobe_Mode=0, VDAC_Range=0, VDAC_Speed=0, Voltage=400, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDACL, CY_INSTANCE_SHORT_NAME=VDACL, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=VDACL, )
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=100, Strobe_Mode=0, VDAC_Range=0, VDAC_Speed=0, Voltage=400, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDACH, CY_INSTANCE_SHORT_NAME=VDACH, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=VDACH, )
...
// ADC_SAR_v3_0(ADC_Clock=1, ADC_Clock_Frequency=12000006, ADC_Input_Range=3, ADC_Power=0, ADC_Reference=1, ADC_Resolution=12, ADC_SampleMode=0, Enable_next_out=false, Ref_Voltage=1.024, Ref_Voltage_mV=1024, rm_int=false, Sample_Precharge=6, Sample_Rate=666667, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=ADC_SAR_v3_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_SAR_1, CY_INSTANCE_SHORT_NAME=ADC_SAR_1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=ADC_SAR_1, )
module ADC_SAR_v3_0_6 (
	...
	cy_psoc3_pins_v1_10
		#(.id("a63cdc24-c65e-40fb-89b3-e2a43a3781d1/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
// TIA_v2_0(Capacitive_Feedback=3, Fcorner=567 kHz, Power=2, Resistive_Feedback=0, vdda_value=5, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=TIA_v2_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=TIA_1, CY_INSTANCE_SHORT_NAME=TIA_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=TIA_1, )
module TIA_v2_0_7 (
    Iin,
    Vref,
    Vout);
...
// TIA_v2_0(Capacitive_Feedback=3, Fcorner=567 kHz, Power=2, Resistive_Feedback=0, vdda_value=5, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=TIA_v2_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=TIA_2, CY_INSTANCE_SHORT_NAME=TIA_2, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=TIA_2, )
module TIA_v2_0_8 (
    Iin,
    Vref,
    Vout);
...
module top ;
    ...
    IDAC8_v2_0_0 IDACH (
        ...
        .en(1'b0),
        .ipolarity(1'b0));
    defparam IDACH.Data_Source = 0;
    defparam IDACH.Initial_Value = 120;
    defparam IDACH.Strobe_Mode = 0;
	...
	cy_psoc3_pins_v1_10
		#(.id("c633ce14-d14f-428e-b6aa-0e5a25834aa8"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pin_VDACH_net;
	wire [0:0] tmpFB_0__Pin_VDACH_net;
	wire [0:0] tmpIO_0__Pin_VDACH_net;
	wire [0:0] tmpINTERRUPT_0__Pin_VDACH_net;
	electrical [0:0] tmpSIOVREF__Pin_VDACH_net;

	cy_psoc3_pins_v1_10
		#(.id("9f7d667a-ebb6-40ae-870a-8efa6177b6bf"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_VDACH
		 (.oe(tmpOE__Pin_VDACH_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_VDACH_net[0:0]}),
		  .analog({Net_1076}),
		  .io({tmpIO_0__Pin_VDACH_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_VDACH_net),
		  .interrupt({tmpINTERRUPT_0__Pin_VDACH_net[0:0]}),
		  .annotation({Net_1089}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_VDACH_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    IDAC8_v2_0_3 IDACL (
        ...
        .en(1'b0),
        .ipolarity(1'b0));
    defparam IDACL.Data_Source = 0;
    defparam IDACL.Initial_Value = 120;
    defparam IDACL.Strobe_Mode = 0;

    VDAC8_v1_90_4 VDACL (
        .strobe(1'b0),
        .data(8'b00000000),
        .vOut(Net_1079));
    defparam VDACL.Data_Source = 0;
    defparam VDACL.Initial_Value = 100;
    defparam VDACL.Strobe_Mode = 0;

    VDAC8_v1_90_5 VDACH (
        .strobe(1'b0),
        .data(8'b00000000),
        .vOut(Net_1076));
    defparam VDACH.Data_Source = 0;
    defparam VDACH.Initial_Value = 100;
    defparam VDACH.Strobe_Mode = 0;
	...
	cy_psoc3_pins_v1_10
		#(.id("0882c583-4e6b-44cb-96e9-3934ff0f39f3"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pin_PD2_net;
	wire [0:0] tmpFB_0__Pin_PD2_net;
	wire [0:0] tmpIO_0__Pin_PD2_net;
	wire [0:0] tmpINTERRUPT_0__Pin_PD2_net;
	electrical [0:0] tmpSIOVREF__Pin_PD2_net;

	cy_psoc3_pins_v1_10
		#(.id("d25f6c5b-b671-4296-8882-dfa0a1a09d6f"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_PD2
		 (.oe(tmpOE__Pin_PD2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_PD2_net[0:0]}),
		  .analog({Net_203}),
		  .io({tmpIO_0__Pin_PD2_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_PD2_net),
		  .interrupt({tmpINTERRUPT_0__Pin_PD2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_PD2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_PD1_net;
	wire [0:0] tmpFB_0__Pin_PD1_net;
	wire [0:0] tmpIO_0__Pin_PD1_net;
	wire [0:0] tmpINTERRUPT_0__Pin_PD1_net;
	electrical [0:0] tmpSIOVREF__Pin_PD1_net;

	cy_psoc3_pins_v1_10
		#(.id("fafb4943-f7eb-4968-a026-298620634134"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_PD1
		 (.oe(tmpOE__Pin_PD1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_PD1_net[0:0]}),
		  .analog({Net_200}),
		  .io({tmpIO_0__Pin_PD1_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_PD1_net),
		  .interrupt({tmpINTERRUPT_0__Pin_PD1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_PD1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Pin_IDACH_net;
	wire [0:0] tmpFB_0__Pin_IDACH_net;
	wire [0:0] tmpIO_0__Pin_IDACH_net;
	wire [0:0] tmpINTERRUPT_0__Pin_IDACH_net;
	electrical [0:0] tmpSIOVREF__Pin_IDACH_net;

	cy_psoc3_pins_v1_10
		#(.id("69649a4d-744a-420b-b815-9da4f3f1586c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_IDACH
		 (.oe(tmpOE__Pin_IDACH_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_IDACH_net[0:0]}),
		  .analog({Net_1045}),
		  .io({tmpIO_0__Pin_IDACH_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_IDACH_net),
		  .interrupt({tmpINTERRUPT_0__Pin_IDACH_net[0:0]}),
		  .annotation({Net_852}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_IDACH_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_IDACL_net;
	wire [0:0] tmpFB_0__Pin_IDACL_net;
	wire [0:0] tmpIO_0__Pin_IDACL_net;
	wire [0:0] tmpINTERRUPT_0__Pin_IDACL_net;
	electrical [0:0] tmpSIOVREF__Pin_IDACL_net;

	cy_psoc3_pins_v1_10
		#(.id("63cbc532-edf9-4b43-9e3c-9c263b47c144"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_IDACL
		 (.oe(tmpOE__Pin_IDACL_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_IDACL_net[0:0]}),
		  .analog({Net_861}),
		  .io({tmpIO_0__Pin_IDACL_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_IDACL_net),
		  .interrupt({tmpINTERRUPT_0__Pin_IDACL_net[0:0]}),
		  .annotation({Net_850}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_IDACL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Pin_Status_1_net;
	wire [0:0] tmpFB_0__Pin_Status_1_net;
	wire [0:0] tmpIO_0__Pin_Status_1_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Status_1_net;
	electrical [0:0] tmpSIOVREF__Pin_Status_1_net;

	cy_psoc3_pins_v1_10
		#(.id("e7b90cdd-795a-4620-877a-dea7981c0a7f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Status_1
		 (.oe(tmpOE__Pin_Status_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Status_1_net[0:0]}),
		  .io({tmpIO_0__Pin_Status_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Status_1_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Status_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Status_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("d25c9cd6-6807-4bdd-ae8f-232e2602fcd6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    // -- TFF Start --
    reg  cy_tff_2;
    always @(posedge Net_1151)
    begin
        cy_tff_2 <= Net_938^Net_940;
    end
    assign Net_940 = cy_tff_2;
    // -- TFF End --
    ...
    // -- TFF Start --
    reg  cy_tff_1;
    always @(posedge Net_1155)
    begin
        cy_tff_1 <= Net_973^Net_972;
    end
    assign Net_972 = cy_tff_1;
    // -- TFF End --
	...
	wire [0:0] tmpOE__Pin_VDACL_net;
	wire [0:0] tmpFB_0__Pin_VDACL_net;
	wire [0:0] tmpIO_0__Pin_VDACL_net;
	wire [0:0] tmpINTERRUPT_0__Pin_VDACL_net;
	electrical [0:0] tmpSIOVREF__Pin_VDACL_net;

	cy_psoc3_pins_v1_10
		#(.id("48c4f577-352c-4a51-9390-b749d6866720"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_VDACL
		 (.oe(tmpOE__Pin_VDACL_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_VDACL_net[0:0]}),
		  .analog({Net_1079}),
		  .io({tmpIO_0__Pin_VDACL_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_VDACL_net),
		  .interrupt({tmpINTERRUPT_0__Pin_VDACL_net[0:0]}),
		  .annotation({Net_1088}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_VDACL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
