...
#define BS_IOPINS1_7_VAL ((const uint8 CYFAR *)0x4800016Cu)
...
#define BS_PHUB_CFGMEM1_VAL ((const uint8 CYFAR *)0x4800018Cu)

/* PHUB_CFGMEM3 Address: CYREG_PHUB_CFGMEM3_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM3_VAL ((const uint8 CYFAR *)0x48000190u)

/* PHUB_CFGMEM8 Address: CYREG_PHUB_CFGMEM8_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM8_VAL ((const uint8 CYFAR *)0x48000194u)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)CYREG_PRT0_AMUX, 0x2008u);
	CY_SET_XTND_REG16((void CYFAR *)CYREG_PRT1_AMUX, 0x2010u);
